...
const clearBtn = document.querySelector('#clear-btn') as HTMLButtonElement | null;
const analyzeBtn = document.querySelector('#analyze-btn') as HTMLButtonElement | null;
const num = document.querySelector("#fnum") as HTMLInputElement | null;
const list = document.querySelector("#flist") as HTMLSelectElement | null;
const resul = document.querySelector("#res") as HTMLElement | null;
